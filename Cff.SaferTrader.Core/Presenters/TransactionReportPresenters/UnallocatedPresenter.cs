...
{
    public class UnallocatedPresenter : ReportPresenterTemplate 
    {
        private readonly IUnallocatedView view;
        private readonly ITransactionReportsService service;
        private readonly IReportManager reportManager;

        public UnallocatedPresenter(IUnallocatedView view, ITransactionReportsService service, IReportManager reportManager)
        {
        ...
        protected override void ShowAllClientsReport(bool firstViewOrScopeChangeOnPage)
        {
            ...
            {
                view.DisplayReport(service.LoadUnallocatedReportForAllClients(view.FacilityType(),
        ...
        {
            view.DisplayReport(service.LoadUnallocatedReport(view.ClientId(), view.ClientFacilityType()));
        }
        ...
        {
            return reportManager.CanViewUnallocatedReport();
        }
