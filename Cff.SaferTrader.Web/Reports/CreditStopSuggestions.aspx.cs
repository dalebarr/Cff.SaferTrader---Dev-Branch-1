...
{
    public partial class CreditStopSuggestions : ReportBasePage, ICreditStopSuggestionsView
    {
        protected static string targetName = "";
        private CreditStopSuggestionsPresenter presenter;
        protected void Page_Load(object sender, EventArgs e)
        {
            presenter = new CreditStopSuggestionsPresenter(this, ReportsService.Create(), ReportManagerFactory.Create(this.CurrentScope(), Context.User as CffPrincipal));
        ...
        #region ICreditStopSuggestionsView Members
        ...
        public void DisplayReport(CreditStopSuggestionsReport report)
        {
