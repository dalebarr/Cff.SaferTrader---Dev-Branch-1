<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="CreditNotes.aspx.cs"
    Inherits="Cff.SaferTrader.Web.Reports.CreditNotes" Title="Cashflow Funding Limited | Debtor Management | Credit Notes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ReportHeaderPlaceholder" runat="server">
	...
	<uc:PageDescription ID="creditNotesPageDescription" DescriptionTitle="" DescriptionContent="Credit Notes - Credit note transactions for a chosen month.  <a href='#'>more information</a>" runat="server" />
</asp:Content>
